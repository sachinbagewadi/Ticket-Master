...
import AllTicket from './department-tickets/AllDeptTicket'
import CompletedTicket from './department-tickets/CompletedDeptTicket'
import PendingTicket from './department-tickets/PendingDeptTicket'


class AllDepartmentTicket extends React.Component{
    constructor(props){
        super(props)
        this.state = {
                all:true,
...
export default withRouter(connect()(AllDepartmentTicket))
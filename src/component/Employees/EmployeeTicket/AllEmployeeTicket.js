...
import {employeeFilter} from '../../../selectors/ticketSelector'

function AllTicket(props){
    console.log('esf',props.ticket)
    return(
        <div>
            {
...
const mapStateToProps = (state,props) => {
    const id = props.id
    return {
        ticket : employeeFilter(state.tickets,id),
...
export default withRouter(connect(mapStateToProps)(AllTicket))